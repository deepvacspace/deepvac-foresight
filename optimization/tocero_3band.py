...
from deepvac.pid import _band_range, plan_pid, read_pid_from_tcp

PIDTriplet = Tuple[int, int, int]
BANDS = ("far", "mid", "near")

PID_SCHEDULES = [
	(15, 1000, 0, 15, 1000, 0, 15, 1000, 0),
	(10, 750, 10, 10, 750, 10, 10, 750, 10),
	(10, 500, 40, 10, 500, 40, 10, 500, 40),
	(20, 750, 10, 20, 750, 10, 20, 750, 10),
	(20, 750, 40, 20, 750, 40, 20, 750, 40),
	(20, 750, 20, 20, 750, 20, 20, 750, 20),
	(15, 200, 20, 15, 200, 20, 15, 200, 20),
	(15, 750, 10, 15, 750, 10, 15, 750, 10),
	(10, 200, 20, 10, 200, 20, 10, 200, 20),
	(20, 1000, 10, 20, 1000, 10, 20, 1000, 10),
	(20, 200, 20, 20, 200, 20, 20, 200, 20),
	(15, 200, 10, 15, 200, 10, 15, 200, 10),
	(15, 500, 40, 15, 500, 40, 15, 500, 40),
	(20, 200, 0, 20, 200, 0, 20, 200, 0),
	(20, 1000, 40, 20, 1000, 40, 20, 1000, 40),
	(10, 1000, 20, 10, 1000, 20, 10, 1000, 20),
	(15, 200, 0, 15, 200, 0, 15, 200, 0),
	(5, 1000, 20, 5, 1000, 20, 5, 1000, 20),
	(5, 200, 0, 5, 200, 0, 5, 200, 0),
	(5, 1000, 40, 5, 1000, 40, 5, 1000, 40),
	(20, 500, 20, 20, 500, 20, 20, 500, 20),
	(5, 1000, 0, 5, 1000, 0, 5, 1000, 0),
	(10, 1000, 40, 10, 1000, 40, 10, 1000, 40),
	(10, 1000, 10, 10, 1000, 10, 10, 1000, 10),
	(10, 750, 0, 10, 750, 0, 10, 750, 0),
	(20, 1000, 0, 20, 1000, 0, 20, 1000, 0),
	(5, 750, 10, 5, 750, 10, 5, 750, 10),
	(5, 750, 40, 5, 750, 40, 5, 750, 40),
	(15, 1000, 10, 15, 1000, 10, 15, 1000, 10),
	(20, 500, 0, 20, 500, 0, 20, 500, 0),
	(5, 750, 0, 5, 750, 0, 5, 750, 0),
	(5, 200, 20, 5, 200, 20, 5, 200, 20),
	(15, 750, 40, 15, 750, 40, 15, 750, 40),
	(10, 750, 20, 10, 750, 20, 10, 750, 20),
	(20, 500, 10, 20, 500, 10, 20, 500, 10),
	(15, 1000, 20, 15, 1000, 20, 15, 1000, 20),
	(5, 200, 10, 5, 200, 10, 5, 200, 10),
	(20, 750, 0, 20, 750, 0, 20, 750, 0),
	(15, 200, 40, 15, 200, 40, 15, 200, 40),
	(20, 500, 40, 20, 500, 40, 20, 500, 40),
	(20, 200, 40, 20, 200, 40, 20, 200, 40),
	(20, 200, 10, 20, 200, 10, 20, 200, 10),
	(10, 750, 40, 10, 750, 40, 10, 750, 40),
	(15, 500, 10, 15, 500, 10, 15, 500, 10),
	(5, 500, 20, 5, 500, 20, 5, 500, 20),
	(5, 1000, 10, 5, 1000, 10, 5, 1000, 10),
	(5, 200, 40, 5, 200, 40, 5, 200, 40),
	(10, 200, 0, 10, 200, 0, 10, 200, 0),
	(15, 500, 0, 15, 500, 0, 15, 500, 0),
	(10, 500, 0, 10, 500, 0, 10, 500, 0),
	(15, 500, 20, 15, 500, 20, 15, 500, 20),
	(20, 1000, 20, 20, 1000, 20, 20, 1000, 20),
	(10, 500, 20, 10, 500, 20, 10, 500, 20),
	(10, 1000, 0, 10, 1000, 0, 10, 1000, 0),
	(5, 500, 10, 5, 500, 10, 5, 500, 10),
	(15, 750, 20, 15, 750, 20, 15, 750, 20),
	(10, 200, 10, 10, 200, 10, 10, 200, 10),
	(15, 1000, 40, 15, 1000, 40, 15, 1000, 40),
	(10, 200, 40, 10, 200, 40, 10, 200, 40),
	(15, 750, 0, 15, 750, 0, 15, 750, 0),
	(5, 750, 20, 5, 750, 20, 5, 750, 20),
	(10, 500, 10, 10, 500, 10, 10, 500, 10),
	(5, 500, 40, 5, 500, 40, 5, 500, 40),
	(5, 500, 0, 5, 500, 0, 5, 500, 0),
]
...
def build_arg_parser() -> argparse.ArgumentParser:
	...
	ap.add_argument("--far-kp-min", type=int, default=4)
	ap.add_argument("--far-kp-max", type=int, default=8)
	ap.add_argument("--far-ki-min", type=int, default=400)
	ap.add_argument("--far-ki-max", type=int, default=900)
	ap.add_argument("--far-kd-min", type=int, default=0)
	ap.add_argument("--far-kd-max", type=int, default=25)
	...
	ap.add_argument("--near-kp-min", type=int, default=12)
	ap.add_argument("--near-kp-max", type=int, default=22)
	ap.add_argument("--near-ki-min", type=int, default=80)
	ap.add_argument("--near-ki-max", type=int, default=300)
	ap.add_argument("--near-kd-min", type=int, default=20)
...
def run_single_test(
	...
	print(
		...
		f"far={pid_plan['far']} mid={pid_plan['mid']} near={pid_plan['near']}"
	)
