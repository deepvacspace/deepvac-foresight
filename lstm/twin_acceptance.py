#!/usr/bin/env python3
"""Measure how well a trained LSTM checkpoint acts as a digital twin.
...
Examples:
    ...
    python -m lstm.twin_acceptance --mode replay --max-runs 40
    python -m lstm.twin_acceptance --mode horizon --max-runs 40
    python -m lstm.twin_acceptance --mode chamber --num-tests 6 --pid-sets "6,997,16;10,500,20"
"""
...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(
        description="Score a LSTM checkpoint as a whole-run digital twin of the chamber.",
    )
