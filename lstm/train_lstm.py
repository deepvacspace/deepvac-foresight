#!/usr/bin/env python3
"""Train, validate, tune, and test a one-step LSTM plant model from history."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(
        description="Train, validate, tune, and test a one-step LSTM plant model."
    )
...
def train_and_validate(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        best_checkpoint_path = output_dir / "lstm_t1.pt"
        print("\n=== Training ===")
        ...
        plot_training_history(
            ...
            title="One-step LSTM Training Curve",
        )
